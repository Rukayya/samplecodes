<?php
namespace Drupal\bulk_booking\Plugin\Action;
 ...
 *   label = @Translation("Booking confirmation"),
 *   type = "bookingform_entity",
 *   confirm = TRUE
 * )
 */
final class ChangeStatus extends ViewsBulkOperationsActionBase implements ContainerFactoryPluginInterface {
   ...
   * @var string
   */
  protected $entity_type = "bookingform_entity";
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state)
  {
    ...
    $form['booking_status'] = [
      ...
      '#description' => $this->t('Expected bookinf status'),
